...
1)
  ...
  echo "------------------------------------------------------"
  echo "[SUCCESS] VPS 已限速：上行 ${SPEED} Mbps + 下行 ${SPEED} Mbps"
  echo "------------------------------------------------------"
  ;;
